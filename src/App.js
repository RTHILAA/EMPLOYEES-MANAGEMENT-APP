    ...
    <div className="confirmation-overlay">
      <div className="confirmation-dialog">
        ...
        <div className="confirmation-actions">
          <button className="cancel-btn-confirm" onClick={onClose}>
            {cancelText}
          </button>
...
const handleChange = (e) => {
  ...
  const handleConfirmDelete = () => {
    if (employeeToDelete) {
      ...
      setTimeout(() => {
        const UpdatedEmp = employees.filter(
      ...
      <div className="container">
        ...
        <div className="stats-section">
          ...
          <div className="stats-grid">
            <StatsCard
              ...
              color="primary"
              trend={
                totalEmployees === 0 ? "No employees yet" : "Team is growing"
              }
            />
            ...
            <form onSubmit={handleSubmit}>
              ...
              <div>
                ...
                >
                  ...
                  <option value="IT" className="option-it">
                    Information Technology (IT)
                  </option>
                  <option value="HR" className="option-hr">
                    Human Resources (HR)
                  </option>
                  <option value="Finance" className="option-finance">
                    Finance
                  </option>
                  <option value="Sales" className="option-sales">
                    Sales
                  </option>
                </select>
              </div>
        ...
        <div className="list-section">
          <div className="title">
            <UsersRound size={24} />
            <span>
              Employees List ({filteredEmployees.length} of {employees.length})
            </span>
          </div>
                    ...
                    return (
                      ...
                      >
                        ...
                        <td className="actions">
                          ...
                          <UserRoundMinus
                            onClick={() =>
                              handleDeleteClick(emp.id, emp.fullname)
                            }
